...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('sidebar/share_sidebar_admin.php'); ?>
                            ...
                            <div class="block-content collapse in">
								...
								<a data-toggle="modal" href="#backup_delete" id="delete"  class="btn btn-success" name=""><i class="icon-move icon-large"></i> Move</a>
									<?php include('modal_share_delete.php');  ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($conn,"select * FROM admin_shared
										LEFT JOIN admin on admin_shared.admin_id = admin.admin_id
										where shared_admin_id = '$session_id' 
										order by fdatein DESC")or die(mysqli_error());
										while($row = mysqli_fetch_array($query)){
										$id  = $row['admin_shared_id'];
									?>                              
