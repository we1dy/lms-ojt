	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysqli_query($conn,"select * from employee LEFT JOIN class ON employee.class_id = class.class_id ORDER BY employee.employee_id DESC") or die(mysqli_error());
