	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysqli_query($conn,"select * from student LEFT JOIN class ON student.class_id = class.class_id where status = 'Registered' ORDER BY student.employee_id DESC") or die(mysqli_error());
