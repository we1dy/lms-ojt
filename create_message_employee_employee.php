                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								    ...
								    <ul class="nav nav-tabs">
										<li>
											<a href="employee_message.php">For admin</a>
										</li>
										<li class="active"><a href="employee_message_employee.php">For employee</a></li>
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="employee_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($conn,"select * from employee order by firstname ASC");
                                          ...
                                          <div class="controls">
												...
												<script>
															...
															jQuery("#send_message_employee").submit(function(e){
																	...
																	$.ajax({
																		type: "POST",
																		url: "send_message_employee_to_employee.php",
																		data: formData,
																		success: function(html){
																		
																		$.jGrowl("Message Successfully Sended", { header: 'Message Sent' });
																		var delay = 2000;
																			setTimeout(function(){ window.location = 'employee_message.php'  }, delay);  
																		}
																	});
																	return false;
																});
