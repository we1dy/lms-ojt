					...
					<div class="modal-body">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <option></option>
											<?php
											$query1 = mysqli_query($conn,"select * from admin_class where class_id ='$class_id' and school_year != '$school_year'")or die(mysqli_error());
											while($row = mysqli_fetch_array($query1)){
											
											?>
											<option><?php echo $row['school_year']; ?></option>
											<input type="hidden" name="admin_class_id" value="<?php echo $row['admin_class_id']; ?>">
											<?php } ?>
                                            </select>
                                          </div>
                                        </div>
