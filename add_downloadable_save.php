        ...
        if (!file_exists($newname)) {
            ...
            if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
               ...
               // echo "INSERT INTO files (fdesc,floc,fdatein,admin_id,class_id,fname,uploaded_by) VALUES ('$filedesc','$newname',NOW(),'$session_id','$id[$i]','$name','$uploaded_by')";
				...
				mysqli_query($conn,"insert into notification (admin_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'downloadable_employee.php')")or die(mysqli_error());
