...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('employee_message_sidebar.php'); ?>
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class="active"><a href="employee_message.php"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class=""><a href="sent_message_employee.php"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
									
									<?php
								 $query_announcement = mysqli_query($conn,"select * from message
																	LEFT JOIN employee ON employee.employee_id = message.sender_id
								...
								if ($count_my_message != '0'){
								 ...
								 ?>
											...
											<i class="icon-calendar"></i> <?php echo $row['date_sended']; ?>
													...
													<?php include("reply_inbox_message_modal_employee.php"); ?>
													</div>
											</div>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('create_message_employee_employee.php') ?>
            </div>
