...
<body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('backpack_sidebar_admin.php'); ?>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query_backpack = mysqli_query($conn,"select * FROM admin_backpack where admin_id = '$session_id'  order by fdatein DESC ")or die(mysqli_error());
								...
								?>
									...
									<form action="delete_backpack_admin.php" method="post">
									...
									<?php include('modal_backpack_delete.php'); ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($conn,"select * FROM admin_backpack where admin_id = '$session_id'  order by fdatein DESC")or die(mysqli_error());
