...
include('session.php');
	...
	$id=$_POST['selector'];
		...
		for($i=0; $i < $N; $i++)
		{			
			mysqli_query($conn,"insert into teacher_class_announcements (teacher_class_id,admin_id,content,date) values('$id[$i]','$session_id','$content',NOW())")or die(mysqli_error());
