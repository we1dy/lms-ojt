                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <th></th>
										...
										<tbody>
												 <?php
                                    $admin_query = mysqli_query($conn,"select * from admin") or die(mysqli_error());
									...
									<td width="50"><a href="edit_admin.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>
									<?php if ($admin_stat == 'Activated' ){ ?>
									<td width="120"><a href="de_activate.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> Deactivate</a></td>
									<?php }else{ ?>
									<td width="120"><a href="edit_admin.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Activated</a></td>				
									<?php } ?>
                                </tr>
                            <?php } ?>
