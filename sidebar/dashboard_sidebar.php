<div class="span3" id="sidebar">
		...
		<li class="active"><a href="student_dashboard.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Departments</a></li>

			<li class=""><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Courses</a></li>
			<li class="">
